...
CREATE SCHEMA IF NOT EXISTS HEALTHCARE
  COMMENT = 'Raw healthcare data from S3 landing zone';
...
GRANT USAGE ON SCHEMA RAW.HEALTHCARE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT CREATE TABLE ON SCHEMA RAW.HEALTHCARE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT CREATE PIPE ON SCHEMA RAW.HEALTHCARE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT CREATE STAGE ON SCHEMA RAW.HEALTHCARE TO ROLE HEALTHCARE_PIPELINE_ROLE;

-- Grant SELECT on future tables (so dbt can read)
GRANT SELECT ON FUTURE TABLES IN SCHEMA RAW.HEALTHCARE TO ROLE HEALTHCARE_PIPELINE_ROLE;
...
-- Staging layer (Bronze → Silver transformations)
CREATE SCHEMA IF NOT EXISTS STAGING
  COMMENT = 'dbt staging models - cleaned and validated data';
  
-- Grant permissions
GRANT USAGE ON SCHEMA ANALYTICS.STAGING TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT CREATE TABLE ON SCHEMA ANALYTICS.STAGING TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT CREATE VIEW ON SCHEMA ANALYTICS.STAGING TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT SELECT ON FUTURE TABLES IN SCHEMA ANALYTICS.STAGING TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA ANALYTICS.STAGING TO ROLE HEALTHCARE_PIPELINE_ROLE;

```

## Create INTERMEDIATE Schema (for dbt intermediate models)

```sql

-- Intermediate layer (for complex transformations)
CREATE SCHEMA IF NOT EXISTS INTERMEDIATE
  COMMENT = 'dbt intermediate models - joined and enriched data';
  
-- Grant permissions
GRANT USAGE ON SCHEMA ANALYTICS.INTERMEDIATE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT CREATE TABLE ON SCHEMA ANALYTICS.INTERMEDIATE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT CREATE VIEW ON SCHEMA ANALYTICS.INTERMEDIATE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT SELECT ON FUTURE TABLES IN SCHEMA ANALYTICS.INTERMEDIATE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA ANALYTICS.INTERMEDIATE TO ROLE HEALTHCARE_PIPELINE_ROLE;


```

## CREATE SCHEMA IN MARTS DATABASE
### Create CORE Schema (for business metrics)

```sql

USE DATABASE MARTS;

-- Core business metrics (Gold layer)
CREATE SCHEMA IF NOT EXISTS CORE
  COMMENT = 'Business-ready metrics for dashboard consumption';
  
-- Grant permissions
GRANT USAGE ON SCHEMA MARTS.CORE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT CREATE TABLE ON SCHEMA MARTS.CORE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT CREATE VIEW ON SCHEMA MARTS.CORE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT SELECT ON FUTURE TABLES IN SCHEMA MARTS.CORE TO ROLE HEALTHCARE_PIPELINE_ROLE;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA MARTS.CORE TO ROLE HEALTHCARE_PIPELINE_ROLE;
...
-- Check all schemas across all databases
